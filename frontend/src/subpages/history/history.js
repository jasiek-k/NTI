...
export default class History extends React.Component {
  ...
  render() {
    const [
      membersHeader,
      albumsHeader,
    ] = this.props.historyContent.sectionsHeaders;

    return (
      <div className="History-subpage">
        <img className="History-background-pic" src={backPic} alt=""></img>
        ...
        <p className="History-intro-section">
          {this.props.historyContent.introSection}
        </p>
        <div className="History-members-section">
          ...
          <p className="History-names-container">
            <span className="History-name" onClick={() => this.slideShow(1)}>
              Anthony
            </span>
            <span> - </span>
            <span className="History-name" onClick={() => this.slideShow(2)}>
              Josh
            </span>
            <span> - </span>
            <span className="History-name" onClick={() => this.slideShow(3)}>
              Flea
            </span>
            <span> - </span>
            <span className="History-name" onClick={() => this.slideShow(4)}>
              Chad
            </span>
          </p>
